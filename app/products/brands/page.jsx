...
import { fetchBrands, createBrand, deleteBrand, updateBrand } from "@/services/brand";
        ...
        <div className="flex w-full flex-wrap items-center justify-end gap-2">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-lg">
              ...
              <BrandForm isEdit={!!editing} initial={editing} onCancel={handleClose} onSave={onSave} error={error} />
            </DialogContent>
          </Dialog>
        </div>
      </div>
        ...
        <table className="w-full min-w-[700px] text-sm text-left">
          ...
          <tbody>
            {list?.length > 0 ? (
              ...
              <tr><td colSpan={5} className="text-center py-10 text-muted-foreground">No brands found.</td></tr>
            )}
          </tbody>
        </table>
      </div>
