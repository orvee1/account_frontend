...
import { createPayment, deletePayment, fetchPayments, updatePayment } from '@/services/transactions';
...
export default function PaymentsPage() {
    ...
    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this payment?')) {
            deletePayment(id).then(() => loadPayments());
        }
    };
                ...
                <div className="flex flex-1">
                    <main className="flex-1 overflow-auto">
                        <div className="p-4 md:p-6">
                            ...
                            <div className="mb-6">
                                <div>
                                    <p className="text-gray-600 mt-1">Manage money paid transactions</p>
                                </div>
                            </div>
